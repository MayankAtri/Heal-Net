        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-medical dark:text-green-400">HealNet</span>
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navLinks.map((link) => (
              <Link
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  isActive(link.path)
                    ? 'bg-medical dark:bg-green-600 text-white'
            ...
            <button
              ...
              className="ml-4 p-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
